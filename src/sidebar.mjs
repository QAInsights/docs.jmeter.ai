...
export const sidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Mutual TLS (mTLS) & Client Certs', link: '/topics/client-certificates-mtls-keystore' },
      ...
      { label: 'CSV Data Set & Parameterization', link: '/topics/csv-data-set-config-guide' },
      { label: 'JSR223 Groovy Scripting', link: '/topics/jsr223-groovy-scripting-guide' },
      { label: 'Assertions & SLA Validation', link: '/topics/jmeter-assertions-guide' },
      { label: 'Logic Controllers & Flow Control', link: '/topics/logic-controllers-flow-control' },
      { label: 'Timers, Think Time & Pacing', link: '/topics/timers-pacing-throughput-modeling' },
      { label: 'Thread Groups & Workload Modeling', link: '/topics/thread-groups-workload-modeling' },
      { label: 'JDBC Database Load Testing', link: '/topics/jdbc-database-load-testing' },
      { label: 'JVM & OS Performance Tuning', link: '/topics/jmeter-performance-tuning-guide' },
      ...
      { label: 'HTML Dashboard & APDEX Customization', link: '/topics/html-dashboard-report-customization' },
