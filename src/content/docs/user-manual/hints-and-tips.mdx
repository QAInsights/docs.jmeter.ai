...
description: "Practical JMeter tips: share data across threads with properties, debug logging, search the test plan, HiDPI, autosave backups, and keyboard shortcuts."
keywords:
  - JMeter tips
  - JMeter hints
  - JMeter debug logging
  - JMeter properties between threads
...
![Figure 1 - Search raw text in TreeView](/images/screenshots/searching/raw-search.png)
_Figure 1 - Search raw text in TreeView_

![Figure 2 - Result in TreeView](/images/screenshots/searching/raw-search-result.png)
_Figure 2 - Result in TreeView_

![Figure 3 - Search Regexp in TreeView (in this example we search whole word)](/images/screenshots/searching/regexp-search.png)
_Figure 3 - Search Regexp in TreeView (in this example we search whole word)_

![Figure 4 - Result in TreeView](/images/screenshots/searching/regexp-search-result.png)
...
<a id="browser_renderer_view_results_tree"></a>
