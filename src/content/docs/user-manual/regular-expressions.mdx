...
description: "JMeter regular expressions guide - use Jakarta ORO and JDK regex engines for response assertions, extractors, and pattern matching in test plans."
---
