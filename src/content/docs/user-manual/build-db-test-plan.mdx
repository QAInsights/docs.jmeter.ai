...
seoTitle: "JMeter Building a Simple Database Test Plan"
description: "Build a JMeter database test plan to load test JDBC endpoints. Configure 50 users sending SQL queries with JDBC Request samplers and MySQL drivers."
keywords:
  - JMeter Building Simple Database
  - Building a Simple Database Test Plan
...
![Figure 6.1. Thread Group with Default Values](/images/screenshots/jdbctest/threadgroup1.png)
...
![Figure 6.2. JDBC Users Thread Group](/images/screenshots/jdbctest/threadgroup2.png)
...
![Figure 6.3. JDBC Configuration](/images/screenshots/jdbctest/jdbc-config.png)
...
![Figure 6.4. JDBC Request](/images/screenshots/jdbctest/JDBCRequest.png)
...
![Figure 6.5. JDBC Request for the first SQL request](/images/screenshots/jdbctest/JDBCRequest2.png)
...
![Figure 6.6. JDBC Request for the second request](/images/screenshots/jdbctest/JDBCRequest3.png)
...
![Figure 6.7. Graph results Listener](/images/screenshots/jdbctest/jdbc-results.png)
