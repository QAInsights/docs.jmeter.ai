...
seoTitle: "JMeter History/Future"
description: 'History and roadmap of Apache JMeter - from Stefano Mazzocchi''s original JServ testing tool to an Apache Top-Level Project with HTTP/2 and async plans.'
keywords:
  - JMeter History Future
  - History/Future
