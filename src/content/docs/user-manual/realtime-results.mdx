...
description: "Stream JMeter test results in real time to InfluxDB, Graphite, or Grafana dashboards using the Backend Listener for live monitoring during load tests."
---

import RelatedContent from '../../../components/RelatedContent.astro';

{/* SYNCED-BODY:START */}
<a id="realtime-results"></a>
...
<a id="influxdb_db_configuration"></a>
