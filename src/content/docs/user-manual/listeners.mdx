...
description: "JMeter Listeners explained - View Results Tree, Summary Report, Aggregate Graph, and more. Capture, visualize, and export test results in tables and graphs."
...
![**Configuration dialogue**](/images/screenshots/sample_result_config.png)
...
![Figure 1 - **Edit → Save Node As Image**](/images/screenshots/save_image.png)
