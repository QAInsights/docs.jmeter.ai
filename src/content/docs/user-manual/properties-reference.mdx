...
description: "Complete jmeter.properties and user.properties reference: results saving, HTTP, SSL, remote testing, report generator, and runtime configuration."
keywords:
