...
seoTitle: "JMeter Access log sampler Step-by-step"
description: "Replay real production traffic in JMeter using the Access Log Sampler. Convert Apache/Tomcat access logs into realistic load tests with actual user patterns."
keywords:
...
1. Start JMeter
2. Select `Test Plan`
3. Right click       **Add → Threads (Users) → Thread Group**       ![Add Thread Group](/images/screenshots/add-threadgroup.png) _Add Thread Group_
4. Select `Thread Group`
5. Right click       **Add → Sampler → Access Log Sampler**       ![Add Access Log Sampler](/images/screenshots/add-access-log-sampler.png) _Add Access Log Sampler_
6. Right click on `Thread Group`       **Add → Listener → Aggregate Report**       ![Add Aggregate Report](/images/screenshots/add-aggregate-report.png) _Add Aggregate Report_
7. Select the `Access Log Sampler`       ![Access Log Sampler](/images/screenshots/accesslogsampler.png) _Access Log Sampler_
...
11. Select a file for `Log File Location`       ![Filled in Access Log Sampler](/images/screenshots/example-access-log-sampler.png) _Filled in Access Log Sampler_
12. Select Aggregate Report
13. Enter `results.jtl` for filename       ![Aggregate Report with filename](/images/screenshots/example-aggregate-report.png) _Aggregate Report with filename_
