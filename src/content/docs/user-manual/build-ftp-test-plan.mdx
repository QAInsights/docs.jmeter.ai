...
seoTitle: "JMeter Building an FTP Test Plan"
description: "Create a JMeter FTP test plan to load test FTP servers. Simulate users downloading files using FTP Request samplers and FTP Request Defaults."
keywords:
  - JMeter Building FTP Test
...
![Figure 7.1. Thread Group with Default Values](/images/screenshots/webtest/threadgroup.png)
...
![Figure 7.2. FTP Users Thread Group](/images/screenshots/ftptest/threadgroup2.png)
...
to get the Add menu, and then select **Add** → **Config Element** → <strong>FTP Request
Defaults.</strong> Then, select this new element to view its Control Panel (see Figure 7.3).

![Figure 7.3. FTP Request Defaults](/images/screenshots/ftptest/ftp-defaults.png)
...
![Figure 7.4. FTP Defaults for our Test Plan](/images/screenshots/ftptest/ftp-defaults2.png)
...
![Figure 7.5. FTP Request for file1](/images/screenshots/ftptest/ftp-request.png)
...
![Figure 7.6. FTP Request for file2](/images/screenshots/ftptest/ftp-request2.png)
...
![Figure 7.7. View Results in Table Listener](/images/screenshots/ftptest/ftp-results.png)
