...
seoTitle: "JMeter Curl"
description: "Import cURL commands directly into JMeter test plans. Convert curl commands to HTTP Request samplers with support for headers, methods, compression, and auth."
keywords:
  - JMeter Curl
  - Curl
