...
seoTitle: "JMeter Building a Monitor Test Plan (REMOVED since JMet"
description: "Legacy JMeter Monitor Test Plan documentation (deprecated in 3.1, removed in 3.2). Originally monitored Tomcat server performance via JMX during stress tests."
keywords:
  - JMeter Building Monitor Test
  - Building a Monitor Test Plan (REMOVED si
...
[Test Plan](/user-manual/build-test-plan/) to monitor webservers. Monitors
...
<a id="adding_server"></a>

## 12.1 Adding A Server

The first step is to add a [Thread Group](/user-manual/test-plan/#thread_group)
...
![Figure 12.1. Thread Group with Default Values](/images/screenshots/webtest/threadgroup.png)
_Figure 12.1. Thread Group with Default Values_
...
Add the [HTTP Authorization Manager](/user-manual/component-reference/#HTTP_Authorization_Manager) to the Thread Group element
...
<a id="adding_request"></a>

## 12.3 Adding HTTP Request

Add the [HTTP Request](/user-manual/component-reference/#HTTP_Request) to the Thread Group element
...
If you want to save the raw results from the server, add a simple data
 [Listener](/user-manual/component-reference/#listeners). If you want to save the
...
Select the thread group element and add a [Simple Data Writer](/user-manual/component-reference/#Simple_Data_Writer) listener
...
<a id="add_monitor_listener"></a>

## 12.6 Adding Monitor Results

Add the [Listener](/user-manual/component-reference/#listeners) by selecting the
test plan element
...
![monitor_health.png](/images/screenshots/monitor_health.png)
...
![monitor_screencap.png](/images/screenshots/monitor_screencap.png)
