...
description: "Deep dive into JMeter test plan components: Thread Groups, Controllers, Samplers, Listeners, Timers, Assertions, Config Elements, and Pre-Processors."
---
...
![Figure 1 -
    Test Plan Showing Accessibility of Configuration Elements](/images/screenshots/http-config/http-config-example.png)
_Figure 1 -
...
![Example test tree](/images/screenshots/scoping1.png)
_Example test tree_
...
![Hierarchy example](/images/screenshots/scoping2.png)
_Hierarchy example_
...
![complex example](/images/screenshots/scoping3.png)
_complex example_
