...
description: "Generate JMeter HTML dashboard reports with APDEX, statistics, percentiles, error tables, and graphs from CSV results using -e -o or offline mode."
keywords:
  - JMeter dashboard
  - JMeter HTML report
  - JMeter APDEX
...
- A request summary graph showing the Success and failed requests (Transaction Controller Sample Results are not taken into account) percentage: ![dashboard/report_apdex_and_summary.png](/images/screenshots/dashboard/report_apdex_and_summary.png)
- A Statistics table providing in one table a summary of all metrics per transaction including 3 configurable percentiles: ![dashboard/report_statistics.png](/images/screenshots/dashboard/report_statistics.png)
- An error table providing a summary of all errors and their proportion in the total requests: ![dashboard/report_errors.png](/images/screenshots/dashboard/report_errors.png)
- A Top 5 Errors by Sampler table providing for every Sampler (excluding Transaction Controller by default) the top 5 Errors: ![dashboard/top_5_errors_by_sampler.png](/images/screenshots/dashboard/top_5_errors_by_sampler.png)
- Zoomable chart where you can check/uncheck every transaction to show/hide it for:                          - Response times Over Time (Includes Transaction Controller Sample Results): ![dashboard/report_response_times_over_time.png](/images/screenshots/dashboard/report_response_times_over_time.png) - Response times Percentiles Over Time (successful responses only): ![dashboard/response_time_percentiles_over_time.png](/images/screenshots/dashboard/response_time_percentiles_over_time.png) - Active Threads Over Time: ![dashboard/report_active_threads_over_time.png](/images/screenshots/dashboard/report_active_threads_over_time.png) - Bytes throughput Over Time (Ignores Transaction Controller Sample Results): ![dashboard/report_bytes_throughput_over_time.png](/images/screenshots/dashboard/report_bytes_throughput_over_time.png) - Latencies Over Time (Includes Transaction Controller Sample Results): ![dashboard/report_latencies_over_time.png](/images/screenshots/dashboard/report_latencies_over_time.png) - Connect Time Over Time (Includes Transaction Controller Sample Results): ![dashboard/report_connect_time_over_time.png](/images/screenshots/dashboard/report_connect_time_over_time.png) - Hits per second (Ignores Transaction Controller Sample Results): ![dashboard/report_hits_per_second.png](/images/screenshots/dashboard/report_hits_per_second.png) - Response codes per second (Ignores Transaction Controller Sample Results): ![dashboard/report_codes_per_second.png](/images/screenshots/dashboard/report_codes_per_second.png) - Transactions per second (Includes Transaction Controller Sample Results): ![dashboard/report_transactions_per_second.png](/images/screenshots/dashboard/report_transactions_per_second.png) - Response Time vs Request per second (Ignores Transaction Controller Sample Results): ![dashboard/report_response_time_vs_request.png](/images/screenshots/dashboard/report_response_time_vs_request.png) - Latency vs Request per second (Ignores Transaction Controller Sample Results): ![dashboard/report_latencies_vs_request.png](/images/screenshots/dashboard/report_latencies_vs_request.png) - Response time Overview (Excludes Transaction Controller Sample Results): ![dashboard/response_time_overview.png](/images/screenshots/dashboard/response_time_overview.png) - Response times percentiles (Includes Transaction Controller Sample Results): ![dashboard/report_response_time_percentiles.png](/images/screenshots/dashboard/report_response_time_percentiles.png) - Times vs Threads (Includes Transaction Controller Sample Results): ![dashboard/report_time_vs_threads.png](/images/screenshots/dashboard/report_time_vs_threads.png)                              :::note In distributed mode, this graph shows a horizontal axis the number of threads for 1 server. It's a current limitation ::: - Response Time Distribution (Includes Transaction Controller Sample Results): ![dashboard/report_response_time_distribution.png](/images/screenshots/dashboard/report_response_time_distribution.png)
...
<a id="configuration_requirements"></a>

#### 14.2.1 Requirements

                    
<a id="saveservice_requirements"></a>
...
<a id="transaction_controller_requirements"></a>
...
- uncheck the box (**this is the default configuration**):                             `Generate parent sample`                             ![transactioncontroller.png](/images/screenshots/transactioncontroller.png)
- If `Transaction Controller` is used as a Container to represent a request for an HTML Page that will trigger Ajax calls and you                             only want in your report the Transaction Controller, then Right click on the node and Apply Naming Policy                             ![apply_naming_policy1.png](/images/screenshots/apply_naming_policy1.png)                             You will obtain this:                             ![apply_naming_policy2.png](/images/screenshots/apply_naming_policy2.png)
...
<a id="general_graph_properties"></a>
...
<a id="specific_graph_properties"></a>
...
<a id="general_export_properties"></a>
...
<a id="specific_export_properties"></a>
...
<a id="graph_export_properties"></a>
...
### 14.3.3 Generation using GUI Tools menu
                ...
                ![Figure 14.1. HTML Report Dialog Menu](/images/screenshots/html_report_menu.png)
