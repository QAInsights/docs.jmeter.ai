...
description: "Full JMeter functions and variables reference: ${__function()} syntax, information, calculation, scripting, and file input functions with parameters."
keywords:
  - JMeter functions
  - JMeter variables reference
  - __UUID
  - __Random
  - __P function
