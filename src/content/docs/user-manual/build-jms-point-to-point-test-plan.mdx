...
seoTitle: "JMeter Building a JMS (Java Messaging Service) Point-to"
description: "Test JMS point-to-point messaging with JMeter. Configure request and reply queues using the JMS Point-to-Point sampler for queue-based load testing."
keywords:
...
below)
            ...
            ![Figure 10.1. Thread Group with Default Values](/images/screenshots/webtest/threadgroup.png)
...
<a id="adding_point_to_point_sampler"></a>
...
Browse button and browse to a directory and then enter a filename.
            ...
            ![Figure 10.2. Graph Results Listener](/images/screenshots/graph_results.png)
