...
seoTitle: "JMeter Building an Extended LDAP Test Plan"
description: 'Create an extended LDAP test plan with JMeter Extended LDAP Sampler: add, delete, search, modify, and compare operations in a step-by-step guide.'
keywords:
  - JMeter Building Extended LDAP
...
![Figure 8b.1. Thread Group with Default Values](/images/screenshots/ldaptest/extthreadgroup.png)
_Figure 8b.1. Thread Group with Default Values_

    
<a id="add_ldapext_defaults"></a>
...
![Figure 8b.2 LDAP Defaults for our Test Plan](/images/screenshots/ldaptest/extrequestdefaults.png)
...
![Figure 8b.3.1. Thread Bind example](/images/screenshots/ldaptest/extthreadbind.png)
_Figure 8b.3.1. Thread Bind example_

<a id="add_searchreq"></a>
...
![Figure 8b.3.2. search request example](/images/screenshots/ldaptest/extsearch.png)
_Figure 8b.3.2. search request example_

<a id="add_comparereq"></a>
...
![Figure 8b.3.3. Compare example](/images/screenshots/ldaptest/extcompare.png)
...
![Figure 8b.3.4. Single bind/unbind example](/images/screenshots/ldaptest/extsbind.png)
...
![Figure 8b.3.5. Add request example](/images/screenshots/ldaptest/extadd.png)
...
![Figure 8b.3.6. Modify example](/images/screenshots/ldaptest/extmod.png)
...
![Figure 8b.3.7. Rename example](/images/screenshots/ldaptest/extmoddn.png)
...
![Figure 8b.3.8. Delete example](/images/screenshots/ldaptest/extdel.png)
...
![Figure 8b.3.9. Unbind example](/images/screenshots/ldaptest/extthreadunbind.png)
_Figure 8b.3.9. Unbind example_

<a id="add_ldapext_listener"></a>
...
![Figure 8b.4. View Result Tree Listener](/images/screenshots/ldaptest/extviewtree.png)
