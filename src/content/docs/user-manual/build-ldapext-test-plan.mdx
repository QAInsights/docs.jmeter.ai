...
description: "Create an extended LDAP test plan using JMeter's highly configurable Extended LDAP Sampler with support for add, delete, search, modify, and compare operations."
---
