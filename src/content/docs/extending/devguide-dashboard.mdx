...
seoTitle: "JMeter Developer's guide: Dashboard generator"
description: "Developer guide to the JMeter dashboard generation engine - understand the modular pipeline that transforms CSV sample data into HTML graphs and statistics."
keywords:
  - JMeter Developer guide Dashboard
  - "Developer's guide: Dashboard generator"
...
#### 1.1 Architecture
                    ...
                    ![Figure 1 - Dashboard generation overview](/images/screenshots/dashboard.png)
...
### 2 Consumers chain details
                ...
                ![Figure 2 - Consumers chain](/images/screenshots/chain.png)
...
<a id="process_template"></a>

### 3 Template processing

                
<a id="template_overview"></a>
