...
seoTitle: "JMeter User guide: Customizables templates"
description: "Create reusable JMeter test plan templates using templates.xml and Freemarker (.jmx.fmkr). Declare, customize, and load templates from the bin/templates folder."
keywords:
  - JMeter User guide Customizables
  - "User guide: Customizables templates"
...
- some .jmx and .jmx.fmkr files which are the templates
                    ...
                    ![Figure 1 - template folder](/images/screenshots/templates/template_folder.png)
...
<a id="template_creation"></a>

### 2 Template declaration

                
<a id="basic_template_declaration"></a>
...
#### 2.1 Basic template declaration
                        ...
                        ![Figure 2 - recording template declaration](/images/screenshots/templates/templates_xml.png)
...
<a id="customizable_template_declaration"></a>
...
#### 2.2 Customizable template declaration
                        ...
                        ![Figure 3 - recording template with parameters](/images/screenshots/templates/templates_xml_parameters.png)
...
<a id="template_file"></a>

### 3 Template file

                
<a id="basic_template_file"></a>
...
<a id="customizable_template_file"></a>
...
```
                        ...
                        ![Figure 4 - recording.jmx save file](/images/screenshots/templates/template_recording_filename.png)
...
```
                        ...
                        ![Figure 5 - JMeter asks you the value you want to put for the key](/images/screenshots/templates/template_parameters_window.png)
_Figure 5 - JMeter asks you the value you want to put for the key_
                        ...
                        ![Figure 6 - the value changed](/images/screenshots/templates/template_recording_retrieved_value.png)
