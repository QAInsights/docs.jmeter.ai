---
title: "Mailing Lists"
seoTitle: "JMeter Mailing Lists"
description: "Apache JMeter mailing lists - subscribe to user and developer discussion forums for configuration questions, development topics, and community support."
keywords:
  - JMeter Mailing Lists
  - Mailing Lists
...
question. Eric Raymond and Rick Moen have even written an essay entitled ["<strong>Asking
Smart Questions</strong>"](http://www.catb.org/~esr/faqs/smart-questions.html) precisely on this topic.  Although somewhat
...
<strong>Do your best to ensure that you are not sending HTML or
    "Stylized" email to the list.</strong>
