...
description: "Master JMeter functions and variables: syntax rules, thread-local vars vs properties, CSV Data Set, __P for CLI, and common parameterization patterns."
keywords:
  - JMeter functions
  - JMeter variables
