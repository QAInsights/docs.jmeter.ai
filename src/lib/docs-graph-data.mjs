...
export const crossLinks = [
  ...
  ['/tools', '/tools/cli-builder'],
  ['/tools/thread-calculator', '/tools/heap-estimator'],
  ['/tools/thread-calculator', '/tools/cli-builder'],
  ['/tools/heap-estimator', '/tools/thread-calculator'],
  ['/tools/cli-builder', '/topics/ci-cd-load-testing'],
  ['/topics/ci-cd-load-testing', '/tools/cli-builder'],
